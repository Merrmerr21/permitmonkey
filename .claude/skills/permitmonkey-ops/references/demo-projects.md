...
- **Storage:** `permitmonkey-demo-assets/placentia/`
...
curl -s https://cc-permitmonkey.vercel.app/api/projects/b0000000-0000-0000-0000-000000000002 \
  -H "Authorization: Bearer $PERMITMONKEY_API_KEY" | jq '.project.status, .latest_output.agent_cost_usd'
```
...
|--------|------|----------|
| permitmonkey-demo-assets | `placentia/plan-binder.pdf` | 32-page plan binder |
| permitmonkey-demo-assets | `placentia/corrections-letter-p1.png` | Corrections page 1 |
| permitmonkey-demo-assets | `placentia/corrections-letter-p2.png` | Corrections page 2 |
| permitmonkey-demo-assets | `placentia/pages-png.tar.gz` | Pre-extracted page PNGs (~30MB) |
| permitmonkey-demo-assets | `placentia/title-blocks.tar.gz` | Pre-cropped title blocks (~1MB) |
| permitmonkey-outputs | `{project_id}/...` | Agent-generated outputs |
