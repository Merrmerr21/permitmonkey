---
name: permitmonkey-ops
version: "1.0"
description: "Operations manual for the PermitMonkey ADU Permit Assistant. Teaches AI agents how to operate the deployed system — trigger flows, check status, read results, navigate the UI, and query the database."
---

# PermitMonkey Operations Manual

This skill teaches you how to operate the PermitMonkey system programmatically and via browser.
...
curl -s https://cc-permitmonkey.vercel.app/api/projects/b0000000-0000-0000-0000-000000000002 \
  -H "Authorization: Bearer $PERMITMONKEY_API_KEY" | jq '.project.status'
```
