# PermitMonkey — Hackathon Schedule
...
- [x] Write plan (plan-permitmonkey.md)
...
- Repo pushed to GitHub: https://github.com/mikeOnBreeze/cc-permitmonkey
...
The plan-permitmonkey.md describes a Cloud Run + Vercel Sandbox architecture. That's the right production architecture, but for the hackathon demo, consider this simpler path:
